 ...
 * @access public
 */
function MLHStrategy(options, verify) {
  options = options || {};
 ...
 */
util.inherits(MLHStrategy, OAuth2Strategy);
 ...
 * @access protected
 */
MLHStrategy.prototype.userProfile = function(accessToken, done) {
  ...
  this.data((err, data) => {
    ...
    try {
      const profile = {
        ...
        phoneNumbers: data.phone_number ? [{ value: data.phone_number }] : [],
        _raw: data,
        _json: data
      };
 ...
 * @api protected
 */
MLHStrategy.prototype.uid = function() {
  return this._data.id;
};

/**
 * Return user info from MyMLH.
 *
 * @return {Object}
 * @api protected
 */
MLHStrategy.prototype.info = function() {
 ...
 * @api protected
 */
MLHStrategy.prototype.data = function(done) {
  if (this._data) {
 ...
 * @api private
 */
MLHStrategy.prototype._buildApiUrl = function() {
 ...
 * @api private
 */
MLHStrategy.prototype._processData = function(data) {
 ...
 * @api private
 */
MLHStrategy.prototype._symbolizeNestedArrays = function(obj) {
